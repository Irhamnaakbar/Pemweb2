...
<html lang="en">
  ...
  <div class="container" style="margin-top:2em; background-color:">
    ...
    <div class="container" style="margin-top:2em;">
        <div class="row">
        <h5 class="card-header bg-primary text-white">IKEA</h5>
            ...
            <form class="form-horizontal" method="post" action="belanja.php" autocomplete="off">
                ...
                <div class="form-group row">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="produk" id="produk_0" type="radio" class="custom-control-input" value="MEJA" required="required"> 
                        <label for="produk_0" class="custom-control-label">MEJA</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="produk" id="produk_1" type="radio" class="custom-control-input" value="KURSI" required="required"> 
                        <label for="produk_1" class="custom-control-label">KURSI</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="produk" id="produk_2" type="radio" class="custom-control-input" value="LEMARI" required="required"> 
                        <label for="produk_2" class="custom-control-label">LEMARI</label>
                    </div>
                    </div>
                </div>
                <div class="form-group row">
            ...
            <div class="col-sm-4" style="background-color:white; padding-top:1em;">
                <table class="table">
                    ...
                    <tr>
                        <td>MEJA: 4.200.000</td>
                    </tr>
                    <tr>
                        <td>KURSI: 3.100.000</td>
                    </tr>
                    <tr>
                        <td>LEMAR-I: 3.800.000</td>
                    </tr>
                    <tr class="text-white bg-primary">
                        <td>BARANG YANG SUDAH DIBELI TIDAK DAPAT DI KEMBALIKAN!</td>
                    </tr>
                </table>
            </div>
        </div>
